...
def parse(args=None):
    ...
    parser.add_argument('--task', choices=['regression', 'classification', 'segmentation'], default='regression',
    ...
    parser.add_argument('--dataset_arr', choices=['scan_age', 'birth_age', 'baileys', 'segmentation'], default='',
