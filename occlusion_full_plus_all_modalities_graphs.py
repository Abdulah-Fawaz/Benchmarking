...
model_list = ['chebnet_nopool','chebnet', 'gconvnet', 'gconvnet_nopool', 'monet' ]
def main():
...
#                    data.metadata = data.metadata.to(device)
        ...
        np.save(resdir+'/K='+str(size_of_hole)+'_occlusion_small_scan_age' + str(model_name)+'.npy', occlusion_results)
